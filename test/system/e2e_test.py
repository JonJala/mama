...
class TestEndToEnd:
    ...
    #########
    # @pytest.mark.parametrize("ss_file", 
    #     [
    #         'two_pop/pop1_pheno1_sumstats.txt',
    #         'two_pop/pop2_pheno1_sumstats.txt'
    #     ])
    def test__two_pops_default_logging__expected_results(self, temp_test_dir):
        ...
        resultfile2 = full_test_prefix + "_POP1_PHENO1.res"
        ...
        assert "0 total SNPs due to non-positive-(semi)-definiteness of omega / sigma" in logtext
        assert "0 total SNPs due to non-positive-(semi)-definiteness of omega / sigma" in sout
