...
class TestFixedOptionHelper:
    ...
    def test__all_free__return_expected(self, size):
        ...
        result1 = mama2.fixed_option_helper(size, mama2.MAMA_REG_OPT_ALL_FREE)
        result2 = mama2.fixed_option_helper(size)
    ...
    def test__all_zero__return_expected(self, size):
        ...
        result = mama2.fixed_option_helper(size, mama2.MAMA_REG_OPT_ALL_ZERO)
    ...
    def test__offdiag_zero__return_expected(self, size):
        ...
        result = mama2.fixed_option_helper(size, mama2.MAMA_REG_OPT_OFFDIAG_ZERO)
    ...
    def test__identity__return_expected(self, size):
        ...
        result = mama2.fixed_option_helper(size, mama2.MAMA_REG_OPT_IDENT)
    ...
    def test__valid_matrix_input__return_expected(self, size):
        ...
        result = mama2.fixed_option_helper(size, M)
    ...
    def test__invalid_matrix_input__return_expected(self, size):
        ...
        with pytest.raises(RuntimeError) as ex_info:
            mama2.fixed_option_helper(size, M)
    ...
    def test__invalid_opt_str_type__return_expected(self):
        ...
        with pytest.raises(RuntimeError) as ex_info:
            mama2.fixed_option_helper(5, float(val))
    ...
    def test__invalid_opt_str_value__return_expected(self):
        ...
        with pytest.raises(RuntimeError) as ex_info:
            mama2.fixed_option_helper(5, val)
...
# TODO(jonbjala) Test fixed_option_helper()
